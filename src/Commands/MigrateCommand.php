...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tenant-klinik:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the TenantKlinik project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for TenantKlinik project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('tenantklinik:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
