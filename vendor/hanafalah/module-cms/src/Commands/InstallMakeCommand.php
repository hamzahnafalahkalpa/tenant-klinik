...
class InstallMakeCommand extends EnvironmentCommand
{
     ...
     * @var string
     */
    protected $signature = 'module-cms:install';
    ...
    {
        $provider = 'Hanafalah\ModuleCms\ModuleCmsServiceProvider';
        ...
        $this->info('✔️  Created config/module-cms.php');
        ...
        $this->comment('hanafalah/module-cms installed successfully.');
    }
}
